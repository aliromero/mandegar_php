...
//    $field['value'] = $field['value']->format('Y-m-d H:i:s');
    $field['value'] = jDate::forge($field['value'])->format('datetime');
}
...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    <script src="{{ asset('vendor/adminlte/plugins/datepicker/bootstrap-persian-datetimepicker.js') }}"></script>
{{--    <script src="{{ asset('vendor/adminlte/plugins/datepicker/fa.js') }}"></script>--}}
...
{{--    <script src="{{ asset('vendor/adminlte/plugins/datepicker/fa-datetimepicker.js') }}"></script>--}}
