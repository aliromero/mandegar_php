...
<div class="form-group col-md-12 checklist_dependency"
     data-entity="{{ $field['field_unique_name'] }}" @include('crud::inc.field_wrapper_attributes')>
    ...
    <div class="row">
        ...
        <div class="col-xs-12" style="overflow-y: scroll;height: 100px;">
        @foreach ($secondary_dependency['model']::all() as $connected_entity_entry)
            <div class="col-sm-{{ isset($secondary_dependency['number_columns']) ? intval(12/$secondary_dependency['number_columns']) : '4'}}">
                <div class="checkbox hidden" secondary_list="{{ $connected_entity_entry->id }}" >
                ...
                thisField.find('.primary_list').change(function () {
                    ...
                    if ($(this).is(':checked')) {
                        ...
                        $.each(dependencyJson[idCurrent], function (key, value) {
                            ...
                            thisField.find('div[secondary_list="' + value + '"]').removeClass("hidden");
...
//                            thisField.find('input.secondary_list[value="' + value + '"]').prop("disabled", true);
                        ...
                        $.each(secondary, function (index, secondaryItem) {
                            ...
                            if (ok) {
                                thisField.find('div[secondary_list="' + secondaryItem + '"]').addClass("hidden");
